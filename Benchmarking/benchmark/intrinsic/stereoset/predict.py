...
if __name__ == "__main__":
    ...
    results = runner()
    ############# 이 부분과 
    # eval.py 의 args.predictions_file = f"{args.persistent_dir}/stereoset/result_3.json" 부분 수정 
    with open(f"{args.persistent_dir}/stereoset/bert_base_plus_lr14_seed74_st350_wm03.json", "w") as f:
