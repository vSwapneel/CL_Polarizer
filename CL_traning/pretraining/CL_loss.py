...
class CLPretraining(nn.Module):
    ...
    def compute_contrastive_loss(self, cosine_sim_plus, cosine_sim_minus, margin):
        '''
        ...
        # 1. anchor-positive proximate
        difference_matrix = cosine_sim_plus - cosine_sim_minus
        # 2. anchor-negative proximate 
